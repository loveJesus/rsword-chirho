...
//! ZCom4 module driver for compressed commentary modules with 12-byte indices.
//!
//! ZCom4 modules store commentary text in compressed blocks with 12-byte verse index entries
//! (4-byte block_num + 4-byte offset + 4-byte size), allowing for larger entries than zCom.
...
/// ZCom4 compressed commentary module driver with 12-byte index entries.
pub struct ZCom4Chirho {
...
impl ZCom4Chirho {
    /// Create a new ZCom4 module from a path and configuration.
    ...
    pub fn iter_chirho(&mut self) -> ZCom4IteratorChirho<'_> {
        ZCom4IteratorChirho {
            module_chirho: self,
...
impl SwModuleChirho for ZCom4Chirho {
...
/// Iterator over ZCom4 module entries.
pub struct ZCom4IteratorChirho<'a> {
    module_chirho: &'a mut ZCom4Chirho,
    finished_chirho: bool,
}

impl<'a> Iterator for ZCom4IteratorChirho<'a> {
