...
//! RawLD4 module driver for uncompressed lexicon/dictionary modules.
//!
//! RawLD4 is functionally identical to RawLD since the underlying RawStr storage
...
/// RawLD4 lexicon module driver.
pub struct RawLd4Chirho {
...
impl RawLd4Chirho {
    /// Create a new RawLD4 module from a path and configuration.
    ...
    pub fn iter_chirho(&mut self) -> RawLd4IteratorChirho<'_> {
        RawLd4IteratorChirho {
            module_chirho: self,
            current_chirho: 0,
        }
    }
...
impl SwModuleChirho for RawLd4Chirho {
...
/// Iterator over RawLD4 module entries.
pub struct RawLd4IteratorChirho<'a> {
    module_chirho: &'a mut RawLd4Chirho,
    current_chirho: u32,
}

impl<'a> Iterator for RawLd4IteratorChirho<'a> {
