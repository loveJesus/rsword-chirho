...
//! Synodal versification system data.
//!
//! This contains the canonical book order and verse counts for the
//! Russian Synodal Bible versification system.

use crate::versification_chirho::{BookInfoChirho, VersificationChirho};

/// Create the Synodal versification system.
pub fn create_synodal_chirho() -> VersificationChirho {
    VersificationChirho::new_chirho("Synodal", create_ot_books_chirho(), create_nt_books_chirho())
}
...
fn create_ot_books_chirho() -> Vec<BookInfoChirho> {
    vec![
        ...
        // Synodal Psalms numbering follows LXX/Vulgate tradition
        BookInfoChirho::new_chirho("Psalms", "Ps", "Ps", vec![
            6, 12, 9, 9, 13, 11, 18, 10, 39, 18,
            7, 9, 6, 7, 11, 15, 51, 15, 10, 14,
